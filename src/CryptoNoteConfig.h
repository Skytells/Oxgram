...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x14; // Starts with (o) as Addr. Prefix
...
const char     CRYPTONOTE_NAME[]                             = "oxgram";
...
const int      P2P_DEFAULT_PORT                              = 17090;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 27090;
